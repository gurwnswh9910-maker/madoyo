...
def _resolve_project_path(env_name, default_path):
...
STORAGE_PATH = _resolve_project_path(
    "MADOYO_EMBEDDING_STORAGE_PATH",
    Path(BASE_PATH) / "upgrade_final_vector" / "embeddings_upgrade_final.pkl",
)
CACHE_PATH = _resolve_project_path("MADOYO_DATA_CACHE_PATH", Path(BASE_PATH) / "data_cache.pkl")
