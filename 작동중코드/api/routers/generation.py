...
from api.config import GEMINI_API_KEY, MODEL_NAME, FALLBACK_MODEL_NAME, BASE_PATH, CACHE_PATH, STORAGE_PATH
...
async def health_check():
    """서버 상태 확인"""
    data_cache_exists = os.path.exists(CACHE_PATH)
    embeddings_exist = os.path.exists(STORAGE_PATH)
